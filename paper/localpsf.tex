...
\begin{description}
\item[Matrix-free:] One cannot easily access kernel entries $\Phi(y,x)$. Access to $\Aop$ is available only through ``operator actions.'' That is, evaluation of the maps
\begin{equation*}
