...
In order to use the product-convolution approximation $\widetilde{\mathcal{A}}$, we convert $\widetilde{\mathcal{A}}$ to hierarchical matrix (H-matrix) format. Many classes of hierarchical matrices exist---H1, uniform H1, H2, HODLR, HSS, HBS, and more. We use H1 matrices in our numerical results, but any of the other H-matrix formats could be used instead. The basic ideas behind H-matrices are as follows:
\begin{itemize} 
...
\begin{equation*}
	...
	\end{bmatrix}
\end{equation*}
where $\widetilde{\mathcal{A}}_{11}$ denotes the block of $\widetilde{\mathcal{A}}$ with rows $r_1$ and columns $c_1$, $\widetilde{\mathcal{A}}_{12}$ denotes the block of $\widetilde{\mathcal{A}}$ with rows $r_1$ and columns $c_2$, and similar for $\widetilde{\mathcal{A}}_{21}$ and $\widetilde{\mathcal{A}}_{22}$.
...
\paragraph{Adaptive cross low rank approximation of blocks} WORK IN PROGRESS
