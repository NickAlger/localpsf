...
\item \referee{possibly interesting references for estimating Hessians
  ...
  \noindent{We added text in the paragraph at the end of Section 2 to discuss the (lack of) applicability of our method to wave inverse problems, and added these references.}
