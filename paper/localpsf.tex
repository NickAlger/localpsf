...
\begin{defn}[Moments of $\phi_x$]
	...
	We define the spatially scaling factor, $\alpha$, the scaled impulse response, $\widehat{\phi}_x$, the spatially varying mean, $\mu$, and the spatially varying covariance, $\Sigma$, as follows:
	\begin{align*}
