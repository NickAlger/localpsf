...
\begin{figure}
	\begin{subfigure}{0.18\textwidth}
		\includegraphics[scale=0.075]{mstar_0.25noise_cropped.png}
		%		\caption{}
	...
	\end{subfigure}
	\begin{subfigure}{0.18\textwidth}
		\includegraphics[scale=0.075]{mstar_0.05noise_cropped.png}
		%		\caption{}
	...
	\end{subfigure}
	\begin{subfigure}{0.18\textwidth}
	\includegraphics[scale=0.075]{mstar_0.01noise_cropped.png}
	%		\caption{}
	%		\label{fig:newtoniter4}
    \end{subfigure}
	\caption{The log basal sliding parameter computed from the PDE-constrained optimization problem with noise levels: $25\%$ (left), $11\%$ (second from left), $5.0\%$ (third from left), $2.2\%$ (fourth from left), and $1.0\%$ (right). The PSF (5) preconditioner is constructed between Newton iterations 3 and 4. \todo{remove reference to newon iterates figure as this figure has a new significance}}
