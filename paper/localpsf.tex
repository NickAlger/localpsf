...
\begin{figure}
	...
	$T=2.0$ & $3.2e-4$    & 524 & 645  & 318   & 379   & 170    \\ 
		...
		\endgroup
	\end{center}
	\caption{Number of preconditioned conjugate gradient iterations to achieve tolerance $10^{-6}$ for solving the Newton linear system in the advection-diffusion inverse problem. Iteration counts are shown for a variety of different diffusion parameters $\kappa$, simulation times $T$, and preconditioners.}
