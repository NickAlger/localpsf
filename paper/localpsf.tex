...
\end{align}
These approximations are illustrated in Figure FIG.

Operators satisfying \eqref{eq:translate1} can be well-approximated via low-rank interpolative factorization of the kernel $\Phi$.
% of the form
%\begin{equation}
