...
\begin{subequations}\label{Stokeseqn}
	...
	\bm{u}\cdot\bm{n} =0 \text{ and } \bm{T}\left(\bm{\sigma}_{\bm{u}}\bm{n}+\exp\left(m\right)\bm{u}\right)
	&=\bm{0}\,\,\,\,\,\,\text{ on }\Gamma_{b},\label{Stokeseqn:4} \\
	\left(\bm{\sigma}_{\bm{u}}\bm{n}+\mu\bm{u}\right)&=\bm{0}\,\,\,\,\,\,\text{ on }\Gamma_{l},\label{Stokeseqn:5}	
	\end{align}
\end{subequations}
whose solution determines the ice flow velocity $\bm{u}$ and pressure $p$. Here, $m$ is the logarithmic
...
and $A$ is a flow rate factor. Glen's exponent has been chosen $n=1$, which provides for a linear Stokes model.

\begin{figure}[H]
	\begin{subfigure}{0.32\textwidth}
    \includegraphics[scale=0.12]{meshHeight_view0_edges_withColorBar.png}	
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
    \includegraphics[scale=0.12]{trueVelocity_glyphs_withColorBar.png}
    \end{subfigure}
    \begin{subfigure}{0.32\textwidth}
    \includegraphics[scale=0.162]{mtrue_withColorBar.png}
    \end{subfigure}
\end{figure} 
...
\begin{figure}[H]
	\begin{subfigure}{0.225\textwidth}
		\includegraphics[scale=0.08]{m1_psf.png}	
	\end{subfigure}
	\begin{subfigure}{0.225\textwidth}
		\includegraphics[scale=0.08]{m3_psf.png}
	\end{subfigure}
	\begin{subfigure}{0.225\textwidth}
		\includegraphics[scale=0.08]{m4_psf.png}
	\end{subfigure}
	\begin{subfigure}{0.225\textwidth}
	\includegraphics[scale=0.08]{m6_psf.png}
\end{subfigure}
