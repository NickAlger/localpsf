...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.10]{meshHeight_view0_edges_withColorBar.png}	
    \end{subfigure}
    \begin{subfigure}{0.275\textwidth}
    \includegraphics[scale=0.10]{trueVelocity_glyphs_withColorBar.png}
    \end{subfigure}
    \begin{subfigure}{0.275\textwidth}
    \includegraphics[scale=0.135]{mtrue_withColorBar.png}
    \end{subfigure}
\end{figure} 
