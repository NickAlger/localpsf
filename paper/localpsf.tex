...
\begin{enumerate}
	...
	\begin{equation}
		\label{eq:S_matrix}
		S_{ij} := \int_\Omega \firstgreens_i(x) \firstgreens_j(x) dx.
	\end{equation}
\end{enumerate}
...
\begin{equation*}
	\boldsymbol{\dcomb}^b_i = \sum_{x_j \in S_b} f_i(x_j), \quad i=1,\dots,N.
\end{equation*}
