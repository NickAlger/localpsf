...
\section{Overview of the method and illustration on a blur operator}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.25]{frog_moments2.pdf}	
	\caption{asdf3
	}
	\label{fig:frog2}
\end{figure}
...
%		\caption{PSF(20)}
	...
	\caption{columnwise error plots for kernel reconstruction left 5, center 10, right 20
	}
	\label{fig:frog5}
\end{figure}
...
\subsection{Example 2: Inversion for the initial condition in an advective-diffusive transport problem}
\label{sec:adv}
