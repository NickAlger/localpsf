...
\begin{figure}
	...
	\caption{
		...
		(Bottom left) True parameter, $\basalfriction_\text{true}$. (Bottom right) True velocity $\velocity_\text{true}$. Arrows indicate the direction of $\velocity_\text{true}$ and color indicates the magnitude of $\velocity_\text{true}$.}
