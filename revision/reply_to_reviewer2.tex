...
\item \referee{Interesting work, generally well-written. Perhaps a
  ...
  \noindent{Thank you for this suggestion! We added a 2D blurring kernel example, with figures illustrating the end-to-end PSF method. These are shown in the introduction and the numerical results sections (Sections 1 and 7.1). We think that adding these illustrations helps the reader better understand the intuition behind the method.
