...
# ns= 0.05
# kp= 0.00017782794100389227
# tf= 2.0

all_noise_levels = [0.05] #[0.05, 0.1, 0.2]
all_kappa = [list(np.logspace(-4, -3, 5))[1]]
all_t_final = [2.0]
...
for ii, ns in enumerate(all_noise_levels):
    for jj, kp in enumerate(all_kappa):
        for kk, tf in enumerate(all_t_final):
            ...
            areg_morozov = 8.748754081965675e-06
            ...
            # #
            #
            # print('Solving randn rhs to tight tol with areg_morozov')
...
#   matrix has dimension 7863 x 7863
#     no of non-zeroes    = 149015
#     matrix is             real valued
#     format              = non symmetric
#   size of sparse matrix = 2.33 MB
#   |S|_F                 = 1.72517e+07
#     sparsity constant = 60
#     size of H-matrix  = 34.70 MB
#     |A|_F             = 1.72517e+07
#  |S-A|_2 = 6.62649e-10
# relerr_invCL_hmatrix= 2.489026009404895e-16
#
# ━━ LU factorisation ( rtol = 1e-07 )
#     done in 11.96s
#     size of LU factor = 42.57 MB
# building psf object
# Preparing c++ object
