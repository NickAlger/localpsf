...
\begin{equation*}
	\prod_{i=1}^\gdim \left[ \spatialmean_i -\sqrt{\Sigma_{ii}}/\tau, \spatialmean_i +\sqrt{\Sigma_{ii}}/\tau \right],
\end{equation*}
...
\end{equation*}
intersect if and only if $a_i^- \le b_i^+$ and $b_i^- \le a_i^+$ for $i=1,\dots,d$\footnote{See \url{https://stackoverflow.com/a/65107290/484944}}.
