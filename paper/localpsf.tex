...
In general, product-convolution approximations are approximations of the form \eqref{eq:product_convolution}, but where $\varphi_i$ and $w_i$ may be arbitrary functions. 
...
Geometry-aware weighting functions vs radial basis functions
