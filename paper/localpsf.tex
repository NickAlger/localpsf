...
Our overall strategy is to form a product-convolution approximation, $\AopPc$, of $\Aop$ using only operator actions, then convert $\AopPc$ into an H-matrix, which we denote by $\AmatPc$. Schematically,
\begin{equation*}
