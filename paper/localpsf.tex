...
These methods (which we do not use here) have been used to approximate Hessians in PDE constrained inverse problems \cite{AmbartsumyanEtAl20,HartlandEtAl22}. 
...
\begin{itemize}
	\item Picture of velocity field, initial condition, final condition, reconstruction (1)
	\item Impulse responses: vary time and Peclet number (3)
	\item CG convergence (1)
	\item CG iters vs Peclet number (Morozov) (2)
