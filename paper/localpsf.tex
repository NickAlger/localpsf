...
characteristic length of $0.25$ of the domain radius. For the
specific setup, we refer the reader
to~\cite[Section 2.2]{VillaPetraGhattas21}. We choose the regularization
...
conjugate gradient (PCG) scheme and a globalizing Armijo line search~\cite{NocedalWright99}. The (discrete) Newton updates,
