...
\newcommand{\weakadmconst}{C_\text{adm}}
\newcommand{\horizinterpolant}{f}
\newcommand{\interpolatedvalues}{b}
\newcommand{\firstgreens}{\psi}
\newcommand{\secondgreens}{\theta}
\newcommand{\impulseresponse}{\phi}
\newcommand{\convkernel}{\varphi}
\newcommand{\febasis}{\psi}
\newcommand{\ratfct}{s}
\newcommand{\ratpole}{{c_3}}
\newcommand{\spatialvol}{\alpha}
