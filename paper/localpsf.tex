...
\paragraph{(3) Performing linear algebra operations with the H-matrix} It is well-known that H-matrix methods for matrix-vector products, matrix-matrix addition, matrix-matrix multiplication, matrix factorization, and matrix inversion require
\begin{equation*}
