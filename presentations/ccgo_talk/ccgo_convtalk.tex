...
%---------------------------------------------------------------------------------%
\begin{frame}
	\frametitle{Local translation invariance}
     \begin{center}
	\includegraphics[width=0.65\columnwidth]{translation_invariance_level_sets.pdf}
...
%---------------------------------------------------------------------------------%
\begin{frame}
 \frametitle{Hessian impulse responses}
 \center
	\only<1>{
		\begin{center}
			\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_2.pdf}
		\end{center}
	}
	\only<2>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_3.pdf}
	\end{center}
}
	\only<3>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_4.pdf}
	\end{center}
}
	\only<4>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_5.pdf}
	\end{center}
}
	\only<5>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_6.pdf}
	\end{center}
}
	\only<6>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_7.pdf}
	\end{center}
}
	\only<7>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_8.pdf}
	\end{center}
}
	\only<8>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_9.pdf}
	\end{center}
}
	\only<9>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_10.pdf}
	\end{center}
}
	\only<10>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_11.pdf}
	\end{center}
}
	\only<11>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_12.pdf}
	\end{center}
}
	\only<12>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_13.pdf}
	\end{center}
}
	\only<13>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_14.pdf}
	\end{center}
}
	\only<14>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_15.pdf}
	\end{center}
}
	\only<15>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_16.pdf}
	\end{center}
}
	\only<16>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_17.pdf}
	\end{center}
}
	\only<17>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_18.pdf}
	\end{center}
}
	\only<18>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_19.pdf}
	\end{center}
}
	\only<19>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_20.pdf}
	\end{center}
}
	\only<20>{
	\begin{center}
		\includegraphics[width=0.5\columnwidth]{ice_hessian_impulse_response_21.pdf}
	\end{center}
}
...
\begin{frame}
	\frametitle{Stage 1: Product-convolution approximation}
	\framesubtitle{Weighting functions used for interpolation of impulse responses}
	\begin{center}
		\includegraphics[width=0.3\columnwidth]{ice_hessian_weighting_function_5.pdf}
		\includegraphics[width=0.3\columnwidth]{ice_hessian_weighting_function_8.pdf}
		\includegraphics[width=0.3\columnwidth]{ice_hessian_weighting_function_27.pdf}
	\end{center}
\end{frame}
