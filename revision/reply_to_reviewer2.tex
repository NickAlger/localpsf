...
\item \referee{Perhaps it is illustrative to include some 1D blurring
  ...
  \noindent{Maybe we can answer with the wave problem discussion from
    reviewer 1. or even cook up a 2D deblurring problem, such that the
    Hessian entries will be some modified Gaussians.}
